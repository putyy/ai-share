...
import {getPptTypeList, getShareResourceList, getShareResourceTypeList, postLock} from "../../common/api"
import PptTypeEdit from '../../components/ppt/PptTypeEdit.vue'
...
const tableList = () => {
  ...
  getPptTypeList(searchFormData).then((res) => {
...
<template>
  ...
  <PptTypeEdit :rowInfo="rowInfo" @changeRow="onChangeRow"/>
