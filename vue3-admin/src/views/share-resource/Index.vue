...
import {getShareResourceList} from "../../common/api"
import ShareResourceEdit from '../../components/share-resource/ShareResourceEdit.vue'
...
const tableList = () => {
  ...
  getShareResourceList(searchFormData).then((res) => {
...
<template>
  <el-container class="my-table-container">
    ...
    <el-table :data="tableData" height="70vh" style="width: 100%">
      ...
      <el-table-column prop="share_resource_type.name" label="分类"/>
  ...
  <ShareResourceEdit :rowInfo="rowInfo" @changeRow="onChangeRow"/>
